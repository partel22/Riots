...
# print(soup.prettify())
link = soup.find_all('a', {'class': 'list-card-link list-card-link-top-margin'})
...
for i in range(len(link)):
    driver.get("https://forms.gle/iKLt86ejPDc7Etay8")
    time.sleep(5)
    ...
    driver.find_element(By.XPATH, '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input').send_keys(link[i])
